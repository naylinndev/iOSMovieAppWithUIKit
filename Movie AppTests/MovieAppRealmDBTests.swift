...
final class MovieAppRealmDBTests: QuickSpec {
    ...
    func testSaveRecord() {
        ...
        do {
            ...
            fail("Impossible to save the current record")
        }
    ...
    func testSaveAndFetch() {
        ...
        describe("Retrieve Records and it should return count as 2"){
            do {
    ...
    func testSaveAndFetchWithPredicate() {
        self.testSaveRecord()
        describe("Filter Dog age equal 1 and it should return count as 1") {
            do {
                let exp = self.expectation(description: "wait for fetch")
